      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 py-12 md:flex-row md:items-center md:justify-between md:px-6">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-4">
          <a
            ...
            className="text-sm text-linen transition-colors hover:text-brass"
          >
            (672) 999-9761
          </a>
          <a
            ...
            className="flex items-center gap-1.5 text-sm text-[#25D366] transition-opacity hover:opacity-80"
          >
